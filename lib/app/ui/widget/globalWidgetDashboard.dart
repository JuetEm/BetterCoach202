...
import 'package:web_project/app/ui/animation/favoriteBottonExample.dart';
...
class _GlobalWidgetDashboardState extends State<GlobalWidgetDashboard> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ActionService>(builder: (context, actionService, child) {
      return Scaffold(
        appBar: BaseAppBarMethod(context, "글로벌 위젯 대쉬보드", null, null, null),
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              LikeButtonExample(isFavorite: true, size: 30,onTap: (){}),
