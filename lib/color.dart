...
class Palette {
  ...
  static const Color buttonKakao = Color(0xFFFEE500);
  ...
  static const Color textOrange = Color(0xFFFF8A29);

  ///Gray Scale
  static const Color gray00 = Color(0xFF000000);
  ...
  static const Color grayFF = Color(0xFFFFFFFF);
}
